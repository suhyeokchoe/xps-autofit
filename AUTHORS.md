...
- Research interests: Surface analysis (XPS), XRD, SEM, materials characterization,
...
기꺼이 데이터를 이용하게 해주신 경북대 신소재 김성찬 교수님께 감사의 말씀을 전합니다.
...
- **기능 제안**: [GitHub Issues](https://github.com/suhyeokchoe/xps-autofit/issues)
- **새 재료 템플릿 제안**: 본인 분야에서 자주 쓰는 재료의 표준 컴포넌트 정보를
  Issue로 알려주시면 라이브러리에 추가해드리겠습니다!
- **데이터 기여**: 검증용 reference 데이터(재료 + 측정 조건)를 제공해주시면 더 나은 서비스와
              더 멋진 기능들을 약속해드리겠습니다!
...
당신의 연구는 지금 이 순간에도 세상의 경계를 넓히고 있습니다.
신소재공학 화이팅!
